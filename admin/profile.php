                ...
                <div id="edit" class="tabcontent" style="display: none;">
                    <form class="profile-form">
                        <div class="form-section">
                            ...
                            <label>First Name</label>
                            <input type="text" value="<?php echo htmlspecialchars($user['firstName']); ?>" placeholder="Shakira">
                            <label>Middle Name</label>
                            <input type="text" value="<?php echo htmlspecialchars($user['middleName']); ?>" placeholder="Shakira">
                            <label>Last Name</label>
                            <input type="text" value="<?php echo htmlspecialchars($user['lastName']); ?>" placeholder="Morales">
                            <label>Phone Number</label>
                            <input type="text" value="<?php echo htmlspecialchars($user['phoneNumber']); ?>" placeholder="09123456789">
                            <label>Email</label>
                            <input type="text" value="<?php echo htmlspecialchars($user['emailAddress']); ?>" placeholder="Email">
                        </div>
