...
<head>
  ...
  <body>
    <div class="sidebar">
        ...
        <ul class="menu">
          <li><a href="s_dash.php"><i class="bx bxs-dashboard"></i><span>dashboard</span></a></li>
          <li><a href="s_user.php"><i class="bx bxs-group"></i><span>user management</span></a></li>
          <li><a href="s_itl.php"><i class='bx bxs-doughnut-chart'></i><span>employee ITL</span></a></li>
          <li><a href="s_dtr.php"><i class='bx bxs-time'></i><span>employee DTR</span></a></li>
          <li><a href="s_reports.php"><i class='bx bxs-book-alt'></i><span>reports</span></a></li>
          <?php
